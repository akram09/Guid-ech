    ...
    <div class="container">
      ...
      <section class="card blue-gradient wow fadeIn" id="intro">
        ...
        <div class="card-body text-white text-center py-5 px-5 my-5">
          ...
          <h1 class="mb-4">
            <strong>Trouvez les meilleures offres d’hôtels pas chers</strong>
          </h1>
          <p>
            <strong>Ouvrez votre monde</strong>
          </p>
          <p class="mb-4">
            <strong>L’inspiration qu’il vous faut pour trouver un Hôtel
            pas chers et partir pour un voyage de rêve</strong>
          </p>
      ...
      <section class="pt-5">
        ...
        <div class="wow fadeIn">
          <!--Section heading-->
          <h2 class="h1 text-center mb-5">Trouvez l’hôtel idéal à "wilaya mlwilayat" </h2>
          
          <p class="text-center">Trouvez l’hôtel idéal à "wilaya mlwilayat" que vous partiez en vacances ou en voyage d’affaires, que vous recherchiez une auberge de jeunesse ou un hôtel 5 étoiles à "wilaya mlwilayat " </p>
          <p class="text-center mb-5 pb-5">Des hôtels avec Des meilleurs rapports qualité/prix</p>
